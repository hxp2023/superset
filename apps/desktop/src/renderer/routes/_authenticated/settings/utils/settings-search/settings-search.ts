...
export const SETTING_ITEM_ID = {
	...
	ENVIRONMENTS_PROXY_CREDENTIALS: "environments-proxy-credentials",
...
export const SETTING_ITEM_VARIANT: Record<SettingItemId, SettingVariant> = {
	...
	[SETTING_ITEM_ID.ENVIRONMENTS_PROXY_CREDENTIALS]: "v2",
...
export const SETTINGS_ITEMS: SettingsItem[] = [
	...
	{
		id: SETTING_ITEM_ID.ENVIRONMENTS_PROXY_CREDENTIALS,
		section: "environments",
		title: "Proxy credentials",
		description:
			"Keys injected at the edge that a sandbox can use but never read",
		keywords: [
			"proxy",
			"credential",
			"credentials",
